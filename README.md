# [SOLVED] Trying-To-Git-Pull-With-Error-Cannot-Open-Git-Fetch-Head-Per
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/trying-to-git-pull-with-error-cannot-open-git-fetch-head-per)
>
...
Change the ownership of the .git directory to your user account using `sudo chown -R $USER:$USER ~/CollegePortal/.git` and try again.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/trying-to-git-pull-with-error-cannot-open-git-fetch-head-per)**
